...
export const ABOUT: { label: string; value: string; note?: string }[] = [
  ...
  { label: "만든 방법", value: "Claude Code 와 함께 하루 만에", note: "설계·코드·데이터 정리를 AI 와 대화하며 진행했다" },
  ...
  { label: "로그인", value: "이름 또는 이메일, 비밀번호 없음", note: "사내 테스트용이라 인증을 두지 않았다. 링크는 외부에 공유하지 마세요" },
...
export const CHANGELOG: { version: string; date: string; note: string }[] = [
  {
    version: "0.5",
    date: "2026-09-17",
    note: "이름으로도 로그인. 피드백을 Vercel Blob 에 영구 저장. 배지를 누르면 개발 환경 소개.",
  },
  {
    version: "0.4",
    date: "2026-09-17",
